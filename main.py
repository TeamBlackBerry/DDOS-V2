...
def get_proxylist(type):
    if type == "SOCKS5":
        ...
        open("./tbbddos/socks5.txt", 'w').write(r)
        r = r.rstrip().split('\r\n')
        return r
    elif type == "HTTP":
        ...
        open("./tbbddos/http.txt", 'w').write(r)
        r = r.rstrip().split('\r\n')
        return r
...
def title():
    ...
    stdout.write("             "+Fore.LIGHTCYAN_EX+"╔═════════╩═════════════════════════════════╩═════════╗\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+"║ "+Fore.LIGHTWHITE_EX   +"    Welcome AKING V2            ║\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+"║ "+Fore.LIGHTWHITE_EX   +"    Contract @A_R_M_A_N_HUSSEN "+Fore.LIGHTCYAN_EX  +"  \n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+"╚═════════════════════════════════════════════════════╝\n")
    stdout.write("\n")
##############################################################################################
def command():
    stdout.write(Fore.LIGHTCYAN_EX+"╔═══"+Fore.LIGHTCYAN_EX+"[""PrInCe"+Fore.LIGHTGREEN_EX+"@"+Fore.LIGHTCYAN_EX+"AKING V2 "+Fore.CYAN+"]"+Fore.LIGHTCYAN_EX+"\n╚══\x1b[38;2;0;255;189m> "+Fore.WHITE)
    command = input()
...
##############################################################################################     
        ...
        stdout.write(Fore.MAGENTA+" [>] "+Fore.WHITE+"Unknown command.\n")  
##############################################################################################   
...
if __name__ == '__main__':
    init(convert=True)
    if len(sys.argv) < 2:
        ua = open('./tbbddos/ddos.txt', 'r').read().split('\n')
        clear()
        title()
        while True:
            command()
        ...
        stdout.write("Author: Arman Hossen (TEAMBLACKBERRY) \n")
